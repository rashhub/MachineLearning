...
\]
\BEQ
p(h_k|\vv) = \Pi_k \sigmoid{b_k + v^T \theta_k}
...
$\bg_{\theta}^0 = \bg_{\theta}^0 + \frac{1}{T}\left\{\vv^t.* \hh^{t'}\right\}$;
$\bg_{\aaa}^0 = \bg_{\aaa}^0 + \frac{1}{T}\vv^t$\;
$\bg_{\bb}^0 = \bg_{\bb}^0 + \frac{1}{T}\hh^t$\;
Sample $\vv^{t,1}$ from $p(\vv|\hh^t,\Theta,\aaa,\bb)$ \;
Sample $\hh^{t,1}$ from $p(\hh|\vv^{t,1},\Theta,\aaa,\bb)$ \;
$\bg_{\theta}^1 =  \bg_{\theta}^1 + \frac{1}{T}\left\{\vv^{t,1}.*\hh^{t,1'}\right\}$\;
$\bg_{\aaa}^1 = \bg_{\aaa}^1 + \frac{1}{T}\vv^{t,1}$\;
$\bg_{\bb}^1 = \bg_{\bb}^1 + \frac{1}{T}\hh^{t,1}$\;
